  ...
  return (
    <div
      ...
      className={`
        ...
        px-4 py-3 bg-none dark:frosted-glass border-2 border-gray-30 rounded-lg
    ...
    >
      {/* Course Code */}
      <span className="font-semibold text-gray-800 dark:text-gray-100 select-none pointer-events-none">
        {courseCode}
      </span>
      ...
      {onRemove && (
        <button
          ...
          className="
            ml-2 w-6 h-6 flex items-center justify-center flex-shrink-0
